      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          >
            ...
            {/* LEETCODE */}
            <a
              href="https://leetcode.com/u/tusharr-chourasiya/"
              target="_blank"
              rel="noopener noreferrer"
              className="border border-yellow-500 text-yellow-400 hover:bg-yellow-500 hover:text-black px-6 py-3 rounded-lg transition flex items-center gap-2"
            >
              <Code2 size={18} />
              LeetCode
            </a>
